...
import { CreateTransfersController } from '../modules/statements/useCases/transfers/CreateTransfersController';
...
const createstatementtransfer = new CreateTransfersController();
...
statementRouter.post('/transfer/:user_id', createstatementtransfer.handle);
